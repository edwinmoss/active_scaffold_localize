ActiveScaffold::Localization.define('de-de') do |lang|
  ...
  lang['Create %s'] ||= 'Erstellen'
  lang['Create Another'] ||= 'Neu'
  ...
  lang['Next'] ||= 'Vor'
  lang['Next %d'] ||= 'Next %d'
  lang['No Entries'] ||= 'Keine Daten vorhanden'
  ...
  lang['Replace With New'] ||= 'Ersetzen'
  lang['Reset'] ||= 'Zur&uuml;cksetzen'
  lang['Saving…'] ||= 'Saving…'
  lang['Search'] ||= 'Suchen'
  lang['Search Terms'] ||= 'Search Terms'
  lang['- select -'] ||= '- Bitte w&auml;hlen -'
  lang['Show'] ||= 'Anzeigen'
  lang['Show %s'] ||= 'Info &uuml;ber %s'
  lang[' to '] ||= ' to '
  lang['Update'] ||= 'Speichern'
  lang['Update %s'] ||= 'Bearbeite'
