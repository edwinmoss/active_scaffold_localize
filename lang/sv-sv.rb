ActiveScaffold::Localization.define('sv-sv') do |lang|
  lang['Add'] ||= 'Add'
  lang['Add Existing'] ||= 'L&auml;gg till fr&aring;n befintlig'
  lang['Are you sure?'] ||= '&Auml;r du s&auml;ker?'
  lang['Cancel'] ||= 'Avbryt'
  lang['Click to edit'] ||= 'Click to edit'
  lang['Close'] ||= 'Close'
  lang['Create'] ||= 'Skapa'
  lang['Create %s'] ||= 'Skapa'
  lang['Create Another'] ||= 'Skapa en till'
  lang['Created %s'] ||= 'Skapad %s'
  lang['Create New'] ||= 'Skapa ny'
  ...
  lang['Replace With New'] ||= 'Ers&auml;tt med ny'
  lang['Reset'] ||= 'Nollst&auml;ll'
  lang['Saving…'] ||= 'Saving…'
